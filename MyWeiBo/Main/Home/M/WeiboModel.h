 ...
 */
@interface WeiboModel : JSONModel
...
@property(nonatomic,copy)NSString       <Optional>*thumbnail_pic;     //缩略图片地址
...
@property(nonatomic,strong)NSDictionary <Optional>*geo;               //地理信息字段
